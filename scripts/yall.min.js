...
var yall = function() {
    function t() {
        ...
        "IntersectionObserver"in window && "IntersectionObserverEntry"in window && "intersectionRatio"in window.IntersectionObserverEntry.prototype && "isIntersecting"in window.IntersectionObserverEntry.prototype && ("loading"in HTMLImageElement.prototype || !this.useLoading) || (this.fsafari = !0,
    ...
    return _createClass(t, [{
        ...
        value: function(t) {
            ...
            e && (t.src = e),
            r && (t.srcset = r),
            t.classList.add(this.classToLoad),
            this.callback && window[this.callback](t)
        }
    }, {
        key: "run",
        value: function() {
            ...
            if (!this.safari) {
                var e = new IntersectionObserver(function(e, r) {
                    e.forEach(function(e) {
                        e.isIntersecting && (t.loadElem(e.target),
